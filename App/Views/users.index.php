...
<table width="50%" border="1" cellpadding="2" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php echo $user['gender'] == 'm' ? 'Masculino' : 'Feminino'; ?>
            </td>


            <td>
                <?php echo dateConvert($user['birthdate']); ?>
            </td>


            <td>
                <?php echo calculateAge($user['birthdate']); ?> anos</td>
...
<?php else: ?> Nenhum usuário cadastrado
