...
<div class="container centralizar">
    <div>
        <form action="#">
            <button href="#" class="btn btn-home-central" type="submit" formaction="usuario-lista.php">
            ...
            <button href="#" class="btn btn-home-central" type="submit" formaction="cliente-lista.php">
            ...
            <button href="#" class="btn btn-home-central" type="submit" formaction="fornecedor-lista.php">
    ...
    <div >
        <form action="#">
            <button href="#" class="btn btn-home-central" type="submit" formaction="produto-lista.php">
